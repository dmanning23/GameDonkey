...
namespace GameDonkey.Tests
{
    ...
    public class ConstantAccelerationTests
    {
        ...
        public void Persist()
        {
            ...
            var container = new StateContainerModel(new Filename("ConstantAccelerationTests.xml"));
            ...
            //read it back in
            var container2 = new StateContainerModel(new Filename("ConstantAccelerationTests.xml"));
