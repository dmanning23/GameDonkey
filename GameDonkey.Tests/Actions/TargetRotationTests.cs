...
namespace GameDonkey.Tests
{
    ...
    public class TargetRotationTests
    {
        ...
        public void Execute_SetsRotationPerSecond()
        {
            ...
            var action = new TargetRotationAction(owner)
            {
                TargetRotation = new ActionDirection()
                {
            ...
            owner.RotationPerSecond.ShouldBeGreaterThan(0f);
        ...
        public void Persist()
        {
            ...
            var container = new StateContainerModel(new Filename("TargetRotationTests.xml"));
            ...
            //read it back in
            var container2 = new StateContainerModel(new Filename("TargetRotationTests.xml"));
