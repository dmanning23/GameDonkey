...
namespace GameDonkey.Tests
{
    ...
    public class CreateThrowTests
    {
        ...
        public void ModelToAction()
        {
            ...
            var action = new CreateThrowAction(null, model, null);
        ...
        public void Persist()
        {
            ...
            var container = new StateContainerModel(new Filename("CreateThrowTests.xml"));
            ...
            //read it back in
            var container2 = new StateContainerModel(new Filename("CreateThrowTests.xml"));
