...
namespace GameDonkey.Tests
{
    ...
    public class SendStateMessageTests
    {
        ...
        public void Persist()
        {
            ...
            var container = new StateContainerModel(new Filename("SendStateMessageTests.xml"));
            ...
            //read it back in
            var container2 = new StateContainerModel(new Filename("SendStateMessageTests.xml"));
