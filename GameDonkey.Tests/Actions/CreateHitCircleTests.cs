...
namespace GameDonkey.Tests
{
    ...
    public class CreateHitCircleTests
    {
        ...
        public void Persist()
        {
            ...
            var container = new StateContainerModel(new Filename("CreateHitCircleTests.xml"));
            ...
            //read it back in
            var container2 = new StateContainerModel(new Filename("CreateHitCircleTests.xml"));
