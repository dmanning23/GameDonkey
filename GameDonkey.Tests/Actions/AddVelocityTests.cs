...
namespace GameDonkey.Tests
{
    ...
    public class AddVelocityTests
    {
        ...
        public void Persist()
        {
            ...
            var container = new StateContainerModel(new Filename("AddVelocityTests.xml"));
            ...
            //read it back in
            var container2 = new StateContainerModel(new Filename("AddVelocityTests.xml"));
            container2.ReadXmlFile();

            //get the action
            container2.StatesActions.Count.ShouldBe(1);
            container2.StatesActions[0].ActionModels.Count.ShouldBe(1);
            var model2 = container2.StatesActions[0].ActionModels[0] as AddVelocityActionModel;
        ...
        [Test]
        public void Execute_AddsVelocityToOwner()
        {
            var owner = new TestObject();
            var action = new AddVelocityAction(owner)
            {
                Velocity = new ActionDirection()
                {
