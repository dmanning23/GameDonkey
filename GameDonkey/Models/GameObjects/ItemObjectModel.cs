...
namespace GameDonkeyLib
{
    ...
    public abstract class ItemObjectModel
    {
        ...
        public virtual void Activate(IPlayerQueue player, IGameDonkey engine, ContentManager content)
        {
        ...
        public virtual void Deactivate(IPlayerQueue player)
        {
        ...
        protected void AddAnimations(IPlayerQueue player)
        {
            if (null != Animations)
            {
        ...
        protected void RemoveAnimations(IPlayerQueue player)
        {
            if (null != Animations)
            {
        ...
        protected virtual BaseObject ActivateCharacter(IPlayerQueue player, IGameDonkey engine)
        {
        ...
        protected void RemoveCharacter(IPlayerQueue player)
        {
            if (null != ObjectModel)
            {
        ...
        protected void AddStateMachine(IPlayerQueue player)
        {
            if (null != StateChanges)
            {
                player.Character.States.StateMachine.AddStateMachine(StateChanges);
            }
        }

        protected void RemoveStateMachine(IPlayerQueue player)
        {
            if (null != StateChanges)
            {
                player.Character.States.StateMachine.RemoveStateMachine(StateChanges);
            }
        }

        protected void AddStateActions(IPlayerQueue player, IGameDonkey engine, ContentManager content)
        {
            if (null != StateContainerModel)
            {
                ...
                player.Character.States.Actions.AddStateMachineActions(stateActions);
            }
        }

        protected void RemoveStateActions(IPlayerQueue player)
        {
            if (null != StateContainerModel)
            {
                player.Character.States.Actions.RemoveStateMachineActions(StateContainerModel);
            }
        }

        protected void AddGarments(IPlayerQueue player, IGameDonkey engine)
        {
        ...
        protected void RemoveGarments(IPlayerQueue player)
        {
            foreach (var garmentModel in GarmentModels)
            {
        ...
        protected void AddInput(IPlayerQueue player)
        {
            if (null != Moves)
            {
        ...
        protected void RemoveInput(IPlayerQueue player)
        {
            if (null != Moves)
            {
