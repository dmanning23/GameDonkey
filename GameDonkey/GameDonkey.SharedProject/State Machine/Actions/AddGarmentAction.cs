...
namespace GameDonkeyLib
{
	...
	public class AddGarmentAction : TimedAction
	{
					...
					childNode = childNode.NextSibling)
				{
					...
					switch (strName)
					{
						...
						case "garmentFile":
						{
							...
							if (!LoadGarment(rEngine.Renderer, strGarmentFile, content))
							{
								Debug.Assert(false);
								return false;
							}
		...
		public bool LoadGarment(IRenderer rRenderer, Filename strFilename, ContentManager content)
		{
			m_Garment = Owner.MyGarments.LoadGarment(strFilename, rRenderer, content);
