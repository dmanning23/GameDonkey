...
{
	public class CConstantAccelerationAction : IBaseAction
	{
		#region Members
		...
		/// </summary>
		public CConstantAccelerationAction(BaseObject rOwner) : base(rOwner)
		{
		...
		{
			CConstantAccelerationAction myAction = (CConstantAccelerationAction)rInst;
